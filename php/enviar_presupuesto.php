<?php
	...
	$masopciones= $_POST["masopciones"];
	$idiomas= $_POST["idiomas"];	
	$mensaje= $_POST["mensaje"];	
	$fechaentrega= $_POST["fechaentrega"];
	$inversion= $_POST["inversion"];
	$pagrefer= $_POST["pagrefer"];
	...
	"\nNecesidad: " . $necesidad .
	"\nContenido: " . $contenido . 
	"\nMas opciones: " . $masopciones .
	"\nIdiomas: " . $idiomas . 
	"\nMensaje: " . $mensaje .
	"\nFecha de Entrega: " . $fechaentrega .
	"\nInversión: " . $inversion . 	 
	"\nPágina de Referencia: " . $pagrefer . "";
	
	mail($destino, "Contacto", $cuerpomensaje);
?>
...
<body>	
    ...
    <main>
        ...
        <section id="bienvenidos-dis-web">
            ...
            <form action="presupuesto_online.html">
